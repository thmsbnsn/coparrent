  ...
  public: {
    Tables: {
      ...
      family_media_assets: {
        ...
        Relationships: [
          {
            foreignKeyName: "family_media_assets_family_id_fkey"
            columns: ["family_id"]
            isOneToOne: false
            referencedRelation: "families"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "family_media_assets_uploaded_by_fkey"
            columns: ["uploaded_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      message_attachments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "message_attachments_family_id_fkey"
            columns: ["family_id"]
            isOneToOne: false
            referencedRelation: "families"
            referencedColumns: ["id"]
          },
          {
            ...
            isOneToOne: false
            referencedRelation: "family_media_assets"
            referencedColumns: ["id"]
          },
          {
      ...
      nurse_nancy_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "nurse_nancy_messages_thread_id_fkey"
            columns: ["thread_id"]
            isOneToOne: false
            referencedRelation: "nurse_nancy_threads"
            referencedColumns: ["id"]
          },
        ]
      }
