...
export function generateCourtReadyPDF(data: CourtExportData): void {
  ...
  const disclaimer = 'This report contains records generated by CoParrent. Message records are immutable after creation, and the selected report sections are compiled chronologically from stored timestamps and activity history. This documentation is provided for informational purposes and its admissibility in legal proceedings is subject to the rules of the relevant jurisdiction.';
