...
const VERIFY_SUPABASE_URL_KEY = "VERIFY_FAMILY_GAME_SUPABASE_URL";
const VERIFY_SUPABASE_ANON_KEY_KEY = "VERIFY_FAMILY_GAME_SUPABASE_ANON_KEY";
const STAGING_SUPABASE_URL_KEY = "SUPABASE_STAGING_URL";
const STAGING_SUPABASE_ANON_KEY_KEY = "SUPABASE_STAGING_ANON_KEY";
...
async function main() {
  const supabaseUrl = getRequiredEnv(SUPABASE_URL_KEY, [
    VERIFY_SUPABASE_URL_KEY,
    STAGING_SUPABASE_URL_KEY,
    FALLBACK_SUPABASE_URL_KEY,
  ]);
  const supabaseAnonKey = getRequiredEnv(SUPABASE_ANON_KEY_KEY, [
    VERIFY_SUPABASE_ANON_KEY_KEY,
    STAGING_SUPABASE_ANON_KEY_KEY,
    FALLBACK_SUPABASE_ANON_KEY_KEY,
  ]);
